...
<div class="heading">
   <h3>Checkout</h3>
   <p><a href="index.php?include=home">Home</a> <span> / Checkout</span></p>
</div>
...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      ?>
      <p class="grand-total"><span class="name">Grand Total :</span><span class="price">IDR<?= $grand_total; ?></span></p>
      <a href="index.php?include=cart" class="btn">view cart</a>
   </div>
   ...
   <div class="user-info">
      ...
      <a href="index.php?include=update-profile" class="btn">Update Info</a>
      ...
      <a href="index.php?include=update-address" class="btn">Update Address</a>
      <select name="method" class="box" required>
         <option value="" disabled selected>Select Payment Method --</option>
         <option value="cash on delivery">Cash on Delivery</option>
         <option value="mBanking">Credit Card</option>
         <option value="gopay">Gopay</option>
         <option value="shopeepay">Paypal</option>
      </select>
